...
// Down provides a mock function with given fields: ctx, version
func (_m *Migrator) Down(ctx context.Context, version uint) error {
...
// Up provides a mock function with given fields: ctx, version
func (_m *Migrator) Up(ctx context.Context, version uint) error {
	ret := _m.Called(ctx, version)
