...
var optionName = strcase.LowerCamelCase(typemapper.GetGenericTypeNameByT[DatabaseClientOptions]())

func ProvideDatabaseClientOptions(env environment.Environment) (*DatabaseClientOptions, error) {
	return config.BindConfigKey[*DatabaseClientOptions](optionName, env)
}
